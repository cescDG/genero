    ...
    <script>
        $(document).ready(function() {
            ...
            var chart = Highcharts.chart('container', {
                ...
                xAxis: {
                    categories: [
                        '¿Mujeres y hombres tienen la misma oportunidad para obtener un incremento salarial?',
                        '¿Importa el que sea mujer u hombre para ascender o ser promocionada(o)?',
                        '¿Considera que la rotación de personal se da más en mujeres?',
                        '¿Ha influido en su crecimiento profesional su estado civil o ser madre?',
                        '¿Se fomenta la participación por igual de mujeres y hombres para que accedan a puestos directivos, en razón de sus capacidades, actitudes y aptitudes?',
                        '¿Se ha enfrentado a obstáculos para ascender o ser promocionada(o) por su estado civil, embarazo, tener hijas(os), edad, discapacidad, condición de salud o preferencia sexual?'
                    ],
                    //crosshair: true
                },
                yAxis: {
