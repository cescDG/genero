...
var MStepper=function(){
    function E(e){
        var g=this,t=1<arguments.length&&void 0!==arguments[1]?arguments[1]:{};_classCallCheck(this,E),_defineProperty(this,"_init",function(){
            var e=g._formWrapperManager,t=g.getSteps,n=g.options,i=g._methodsBindingManager,r=g._openAction,s=t().steps;g.form=e(),r(s[n.firstActive],void 0,void 0,!0),i(s)
        })
            ,_defineProperty(this,"_methodsBindingManager",function(e){
                var t=1<arguments.length&&void 0!==arguments[1]&&arguments[1],o=g.classes,a=g._formSubmitHandler,l=g._nextStepProxy,c=g._prevStepProxy,p=g._stepTitleClickHandler,d=g.form,v=g.options,n=E.nodesIterator,f=E.tabbingDisabler,u=t?E.removeMultipleEventListeners:E.addMultipleEventListeners,i=function(e){
                    var t=e.getElementsByClassName(o.NEXTSTEPBTN),n=e.getElementsByClassName(o.PREVSTEPBTN),i=e.getElementsByClassName(o.STEPTITLE),r=e.querySelectorAll("input, select, textarea, button"),s=e.querySelectorAll('button[type="submit"]');return u(t,"click",l,!1),u(n,"click",c,!1),v.stepTitleNavigation&&u(i,"click",p),r.length&&u(r[r.length-1],"keydown",f),s&&d&&v.validationFunction&&u(s,"keydown",a),e
                };
